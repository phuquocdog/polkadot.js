...
import { createPhuQuocDog } from './productionPhuquocdog';
...
export function createPhuQuocDogRelay (t: TFunction, firstOnly: boolean, withSort: boolean): LinkOption[] {
  return expandEndpoints(t, [createPhuQuocDog(t)], firstOnly, withSort);
}
